      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="flex gap-4 flex-wrap">
            <a href="mailto:acreciti@acreciti.org" className="text-accent hover:text-accent-dim">Email</a>
            <a href="https://github.com/acrecit" className="text-accent hover:text-accent-dim">GitHub</a>
            <a href="https://x.com/acreciti" className="text-accent hover:text-accent-dim">X/Twitter</a>
            <a href="https://t.me/acreciti" className="text-accent hover:text-accent-dim">Telegram</a>
            <a href="https://discord.com/users/acreciti" className="text-accent hover:text-accent-dim">Discord</a>
          </div>
        </div>
      </div>
    </div>
